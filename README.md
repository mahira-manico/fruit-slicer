...
```bash
git clone https://github.com/mahira-manico/fruit-slicer.git
cd fruit-slicer
```
...
- 🐛 [Open an issue](https://github.com/mahira-manico/fruit-slicer/issues)
...
[![GitHub](https://img.shields.io/badge/GitHub-mahira--manico%2Ffruit--slicer-181717?style=for-the-badge&logo=github)](https://github.com/mahira-manico/fruit-slicer)
